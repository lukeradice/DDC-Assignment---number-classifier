...
def main():
    ...
    noise_test_feature_vectors = system.image_to_reduced_feature(noise_test_images, noise_test_labels)
    ...
    mask_test_feature_vectors = system.image_to_reduced_feature(mask_test_images, mask_test_labels)
